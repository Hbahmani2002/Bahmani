    ...
    public class PdfSigner
    {
            ...
            )
        {
            ...
            try
            {
                ...
                PdfStamper pdfStamper = PdfStamper.CreateSignature(pdfReader, stream, '\0');
           ...
           out IExternalSignature externalSignature)
        {
            try
            {
              ...
              //  var smartCardCertificate = smartCardManager.getSignatureCertificate(false, false);
                ...
                var a1 = Convert.ToString(smartCardCertificate.asX509Certificate2().Issuer);
                var a21 = Convert.ToString(smartCardCertificate.asX509Certificate2().SerialNumber);

                var a31 = Convert.ToString(smartCardCertificate.getSubject().getCommonNameAttribute());

                var a41 = Convert.ToString(smartCardCertificate.getSubject().getSerialNumberAttribute());
